...
const MENTORS_DATA = [
  { name: "Rahul Sharma", role: "Frontend Lead", company: "Ex-Flipkart", rating: "4.9", experience: 6, skills: ["React", "Redux", "TypeScript"], avatarBg: "#6C63FF", initials: "RS" },
  { name: "Priya Patel", role: "DevOps Engineer", company: "Ex-Infosys", rating: "4.7", experience: 8, skills: ["Docker", "Kubernetes", "AWS"], avatarBg: "#00D4AA", initials: "PP" },
  { name: "Arjun Mehta", role: "System Architect", company: "Ex-TCS", rating: "4.8", experience: 10, skills: ["System Design", "Node.js"], avatarBg: "#00B0FF", initials: "AM" },
  { name: "Sneha Gupta", role: "Data Scientist", company: "Startup", rating: "4.6", experience: 4, skills: ["Python", "ML", "TensorFlow"], avatarBg: "#FFD600", initials: "SG" },
  { name: "Vikram Nair", role: "Full Stack Engineer", company: "Ex-Wipro", rating: "4.7", experience: 7, skills: ["React", "Node.js", "MongoDB"], avatarBg: "#FF5A5F", initials: "VN" },
  { name: "Ananya Singh", role: "Backend Developer", company: "Freelancer", rating: "4.5", experience: 5, skills: ["Python", "Django", "REST API"], avatarBg: "#E28743", initials: "AS" }
];
              ...
              {MENTORS_DATA.map((mentor, index) => (
                <div key={index} className="detail-card mentor-card" style={{ minHeight: "auto", padding: "1.75rem", flexDirection: "row", gap: "1.25rem", alignItems: "center" }}>
                  ...
                  <div style={{ flexGrow: "1", display: "flex", flexDirection: "column", gap: "0.25rem", textAlign: "left" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <h4 style={{ fontSize: "1.15rem", fontWeight: "700" }}>{mentor.name}</h4>
